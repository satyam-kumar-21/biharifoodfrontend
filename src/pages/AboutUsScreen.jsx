        ...
        <section className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-8 order-2 lg:order-1">
            ...
            <div className="space-y-4 text-gray-600 text-lg leading-relaxed">
              <p>
                Bihar wala taste was born out of a simple longing—the longing for the authentic, unadulterated flavors of home. We realized that while Bihari cuisine is rich in variety and nutrition, it's often hard to find the genuine taste outside the village borders.
              </p>
              <p>
